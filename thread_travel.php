...
$sql = "SELECT* FROM trd WHERE category = 'travel' ORDER BY last_post_time desc  LIMIT $offset, $no_of_records_per_page;";
...
<body>
	...
	<nav class="crumbs">
		...
		<ol>
			...
			<li class="crumb">Thread_travel</li>
		</ol>
	</nav>
