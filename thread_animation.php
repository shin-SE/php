...
// エラーを出力する
    ...
    $sql = "SELECT* FROM trd WHERE category = 'animation' ORDER BY last_post_time desc  LIMIT $offset, $no_of_records_per_page;";
...
<?php include 'inc/header.php'; ?> 
	<nav class="crumbs">	<!-- ページのナビゲーション -->
		<ol>
			...
			<li class="crumb">Thread_animation</li>
		</ol>
	</nav>
