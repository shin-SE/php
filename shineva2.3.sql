...
--
-- テーブルのデータのダンプ `like_ip`
--

INSERT INTO `like_ip` (`thread_id`, `colume_id`, `user_id`) VALUES
(1000002, 1, 1000);
...
(1, 'ryu', 'なんでことはなかったわ', '2021-11-25 13:29:14', 0, 'f'),
(2, 'ryu', 'floot 2 test', '2021-11-25 13:59:05', 0, 't'),
...
(4, 'ryu', 'floot 2 test', '2021-11-25 13:59:05', 0, 'f'),
...
(1, 'ryu', '特に出会っただから', '2021-11-25 13:34:14', 0, 'f');
...
(1, 'ryu', 'Solaris is a 1961 science fiction novel by Polish ...', '2021-11-25 13:34:14', 1, 'f');
...
(1, 'ryu', '第五共和国（だいごきょうわこく）は、1981年3月から1988年2月の第六共和国成立までの間、大韓民国で存続した政体。この間、大統領に就任した全斗煥が、朴正煕の経済政策を引き継ぐ一方で大規模な体制改革を実施し、第六共和国の比較的安定した民主政治システムの基礎を築いた。', '2021-11-25 13:37:58', 0, 't'),
(3, 'dd', '大阪', '2021-12-13 00:00:00', 0, 't');
